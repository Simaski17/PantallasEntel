...
public class SamsungSSieteEdgeActivity extends AppCompatActivity {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK || keyCode == KeyEvent.KEYCODE_HOME) {
            ...
            Intent i = new Intent(SamsungSSieteEdgeActivity.this,MainActivity.class);
            startActivity(i);
            SamsungSSieteEdgeActivity.this.finish();
