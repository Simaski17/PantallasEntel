...
public class HuaweiPNueveActivity extends AppCompatActivity {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK || keyCode == KeyEvent.KEYCODE_HOME) {
            ...
            Intent i = new Intent(HuaweiPNueveActivity.this,MainActivity.class);
            startActivity(i);
            HuaweiPNueveActivity.this.finish();
