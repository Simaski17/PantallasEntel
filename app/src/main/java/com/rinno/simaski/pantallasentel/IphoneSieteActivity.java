...
public class IphoneSieteActivity extends AppCompatActivity {
    ...
    private class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int pos) {
            switch (pos) {
                ...
                case 0:
                    return new IphoneSieteUnoFragment();
                case 1:
                    return new IphoneSieteDosFragment();
                case 2:
                    return new IphoneSieteTresFragment();
                default:
                    return new IphoneSieteUnoFragment();
            }
        }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK || keyCode == KeyEvent.KEYCODE_HOME) {
            ...
            Intent i = new Intent(IphoneSieteActivity.this,MainActivity.class);
            startActivity(i);
            IphoneSieteActivity.this.finish();
