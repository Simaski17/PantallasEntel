...
public class XperiaXActivity extends AppCompatActivity {
    ...
    private class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int pos) {
            switch (pos) {
                ...
                case 0:
                    return new XperiaXUnoFragment();
                case 1:
                    return new XperiaXDosFragment();
                case 2:
                    return new XperiaXTresFragment();
                default:
                    return new XperiaXUnoFragment();
            }
        }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK || keyCode == KeyEvent.KEYCODE_HOME) {
            ...
            Intent i = new Intent(XperiaXActivity.this,MainActivity.class);
            startActivity(i);
            XperiaXActivity.this.finish();
