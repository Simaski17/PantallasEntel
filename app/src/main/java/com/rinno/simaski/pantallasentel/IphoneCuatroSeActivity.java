...
public class IphoneCuatroSeActivity extends AppCompatActivity {
    ...
    private class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int pos) {
            switch (pos) {
                ...
                case 0:
                    return new IphoneCuatroSeUnoFragment();
                case 1:
                    return new IphoneCuatroSeDosFragment();
                case 2:
                    return new IphoneCuatroSeTresFragment();
                default:
                    return new IphoneCuatroSeUnoFragment();
            }
        }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK || keyCode == KeyEvent.KEYCODE_HOME) {
            ...
            Intent i = new Intent(IphoneCuatroSeActivity.this,MainActivity.class);
            startActivity(i);
            IphoneCuatroSeActivity.this.finish();
